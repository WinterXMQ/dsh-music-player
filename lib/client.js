  ...
  factory: (require) => {
    ...
    function KGOnlinePanel({ panelRef }) {
      ...
      async function collectActivePlaylist() {
        ...
        try {
          const d = await jsonPost('/dsh-music/kg/playlist-collect', { playlist: { specialId: String(pl.id), creatorId: String(pl.creatorId), creatorGid: String(pl.gid), name: pl.name } });
