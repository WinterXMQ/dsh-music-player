...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function startPlay(id) {
      ...
      audio.src = track.url;
      audio.load();
      set({ currentId: id, currentName: track.name, currentArtists: track.artists || [], pendingId: null, pendingName: null, error: null, tocOpen: false, currentSection: '', qqFaved: false, currentQuality: '' });
      syncShufflePos();
