    ...
    function QQOnlinePanel() {
      ...
      const qqJoinMenu = qqJoin ? portalToBody((() => {
        ...
        return React.createElement('div', { className: 'dsh-music-add-pop', ref: qqJoinRef, style },
          React.createElement('div', { className: 'dsh-music-hint', style: { padding: '2px 8px', maxWidth: 190, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' } },
            '加入「' + ((qqJoin.song && qqJoin.song.title) || '') + '」到：'),
