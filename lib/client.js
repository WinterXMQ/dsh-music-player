...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function NowPlayingBar() {
      ...
      return React.createElement('div', { className: 'dsh-music-bar-wrap' },
        React.createElement('div', { className: 'dsh-music-bar' },
          ...
          React.createElement('button', {
            className: panelCls + (hasTrack ? '' : ' right'),
    ...
    function ModeDropdown() {
      ...
      return React.createElement('div', { className: 'dsh-music-mode-menu', ref },
        React.createElement('button', {
    ...
    const PLAYER_CSS = '\n' +
      ...
      '.dsh-music-bar-btn.right { margin-left: auto; }\n' +
      '.dsh-music-mode-trigger.right { margin-left: auto; }\n' +
