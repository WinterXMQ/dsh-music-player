...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const store = {
      ...
      lyricText: '',
      // 系统配置：播放条歌词 / 频谱显示开关（默认开启，存 Host prefs）。
      showLyric: true, showViz: true,
    ...
    function SystemSetting() {
      ...
      return React.createElement('div', { className: 'dsh-music-config' },
        React.createElement('p', { className: 'dsh-music-hint' }, '这里控制播放条上显示的辅助信息。'),
