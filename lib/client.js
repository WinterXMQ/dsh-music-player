...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const PREF_KEYS = new Set([
      ...
      PREF_SHOW_LYRIC, PREF_SHOW_VIZ, PREF_SHOW_PROGRESS, PREF_SHOW_QUALITY, PREF_IMMERSE,
      PREF_LYRIC_FX,
    ]);
    ...
    const store = {
      ...
      lyricFx: 'none',
      // 系统配置：播放条歌词 / 频谱 / 进度条 / 音质徽章显示开关（默认开启，存 Host prefs）。
      showLyric: true, showViz: true, showProgress: true, showQuality: true,
