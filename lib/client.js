...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const PLAYER_CSS = '\n' +
      ...
      // 后台静默观感）。
      '.dsh-music-bar-lyric { flex: 1 1 auto; min-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; text-align: center; color: var(--dsw-alias-label-primary, #e6e6e6); }\n' +
